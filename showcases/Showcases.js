		...
		<div class="myworkshop_showcase">
				<div class="workshop_showcase_mutiitem_ctn">
					<div class="workshop_showcase_multiitem showcase_slot ">
													<canvas id="SLChart" height="87" width="175"></canvas>																
					</div>
				</div>
				<div class="workshop_showcase_mutiitem_ctn">
					<div class="workshop_showcase_multiitem showcase_slot ">
													<canvas id="SLChart2" height="87" width="175"></canvas>																
					</div>
				</div>
				<div class="workshop_showcase_mutiitem_ctn">
					<div class="workshop_showcase_multiitem showcase_slot ">
													<canvas id="SLChart3" height="87" width="175"></canvas>																
					</div>
				</div>
				<div class="workshop_showcase_mutiitem_ctn">
					<div class="workshop_showcase_multiitem showcase_slot ">
													<canvas id="SLChart4" height="87" width="175"></canvas>																
					</div>
				</div>
