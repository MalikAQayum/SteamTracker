...
function SLData_v1(){
    ...
    GM_xmlhttpRequest({
	    ...
	    if(arr.indexOf("25")==-1){/*donothing*/}else{count_arr.unshift(arr2.match(/25/g).length);}
	    if(arr.indexOf("24")==-1){/*donothing*/}else{count_arr.unshift(arr2.match(/24/g).length);}
	    if(arr.indexOf("23")==-1){/*donothing*/}else{count_arr.unshift(arr2.match(/23/g).length);}
	    if(arr.indexOf("22")==-1){/*donothing*/}else{count_arr.unshift(arr2.match(/22/g).length);}
	    if(arr.indexOf("21")==-1){/*donothing*/}else{count_arr.unshift(arr2.match(/21/g).length);}
	    if(arr.indexOf("20")==-1){/*donothing*/}else{count_arr.unshift(arr2.match(/20/g).length);}
	    if(arr.indexOf("19")==-1){/*donothing*/}else{count_arr.unshift(arr2.match(/19/g).length);}
...
function SLData_v2(){
    ...
    GM_xmlhttpRequest({
        ...
        onload: function(response_sl) {
            ...
            if(arr.indexOf("19")==-1){/*donothing*/}else{var newcount19 = arr2.match(/19/g).length; if(isNaN(parseInt(count_arr[0]))){count_arr.unshift(newcount19);}else{ var countadded19 = count_arr[0] + newcount19; count_arr.unshift(countadded19);}}  
            if(arr.indexOf("20")==-1){/*donothing*/}else{var newcount20 = arr2.match(/20/g).length; if(isNaN(parseInt(count_arr[0]))){count_arr.unshift(newcount20);}else{ var countadded20 = count_arr[0] + newcount20; count_arr.unshift(countadded20);}}  
            if(arr.indexOf("21")==-1){/*donothing*/}else{var newcount21 = arr2.match(/21/g).length; if(isNaN(parseInt(count_arr[0]))){count_arr.unshift(newcount21);}else{ var countadded21 = count_arr[0] + newcount21; count_arr.unshift(countadded21);}}  
            if(arr.indexOf("22")==-1){/*donothing*/}else{var newcount22 = arr2.match(/22/g).length; if(isNaN(parseInt(count_arr[0]))){count_arr.unshift(newcount22);}else{ var countadded22 = count_arr[0] + newcount22; count_arr.unshift(countadded22);}}  
            if(arr.indexOf("23")==-1){/*donothing*/}else{var newcount23 = arr2.match(/23/g).length; if(isNaN(parseInt(count_arr[0]))){count_arr.unshift(newcount23);}else{ var countadded23 = count_arr[0] + newcount23; count_arr.unshift(countadded23);}}  
            if(arr.indexOf("24")==-1){/*donothing*/}else{var newcount24 = arr2.match(/24/g).length; if(isNaN(parseInt(count_arr[0]))){count_arr.unshift(newcount24);}else{ var countadded24 = count_arr[0] + newcount24; count_arr.unshift(countadded24);}}  
            if(arr.indexOf("25")==-1){/*donothing*/}else{var newcount25 = arr2.match(/25/g).length; if(isNaN(parseInt(count_arr[0]))){count_arr.unshift(newcount25);}else{ var countadded25 = count_arr[0] + newcount25; count_arr.unshift(countadded25);}}  
